        ...
        */
        function jsTreeData(file) {
            ...
            if (file.type == fileObjectTypes.file) {
                ...
                file.childs.forEach(function (node) {
